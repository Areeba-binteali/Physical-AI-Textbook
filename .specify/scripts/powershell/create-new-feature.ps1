...
if ($Help) {
    ...
    Write-Host "  -FeatureDescriptionPath <path> Read feature description from a file"
    Write-Host "  -Help               Show this help message"
    Write-Host ""
    Write-Host "Examples:"
    Write-Host "  ./create-new-feature.ps1 'Add user authentication system' -ShortName 'user-auth'"
    Write-Host "  ./create-new-feature.ps1 'Implement OAuth2 integration for API'"
    Write-Host "  ./create-new-feature.ps1 -FeatureDescriptionPath './temp/my-feature.txt' -ShortName 'my-feature'"
    exit 0
}

$featureDesc = ""
if ($FeatureDescriptionPath) {
    if (Test-Path $FeatureDescriptionPath) {
        $featureDesc = Get-Content $FeatureDescriptionPath | Out-String
    } else {
